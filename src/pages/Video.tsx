import vidSpcBadge from '@assets/images/badges/SVG/vid_spc.svg';
import vidProBadge from '@assets/images/badges/SVG/vid_pro.svg';
...
const Video = () => {
  ...
  return (
    <>
      <Header
        backgroundImage='bg-video'
        title='Poly Video Solutions'
        ...
        <div>
          ...
          <SectionEnrollments>
            {data
              .filter(
                (course) =>
                  course.level === 'specialist' && course.category.video
              )
              .map(({ ...rest }) => (
                <SectionCourseCard
                  {...rest}
          ...
          <SectionReward
            image={vidSpcBadge}
            description='Poly Video Specialist Certification'
          />
        </div>
      </Container>
        ...
        <div>
          ...
          <SectionEnrollments>
            {data
              .filter(
                (course) =>
                  course.level === 'professional' && course.category.video
              )
              .map(({ ...rest }) => (
                <SectionCourseCard
                  {...rest}
          ...
          <SectionReward
            image={vidProBadge}
            description='Poly Video Professional Certification'
          />
        </div>
      </Container>
      ...
      <Container>
        <div>
          ...
          <SectionEnrollments>
            {data
              .filter(
                (course) => course.level === 'expert' && course.category.video
              )
              .map(({ ...rest }) => (
                <SectionCourseCard
                  {...rest}
